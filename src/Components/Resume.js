  ...
  render() {
    ...
    return (
      ...
      <div className="row skill">
         ...
         <div className="nine columns main-col">
            <p>Coding Languages, frameworks, databases and other web development tools that I have experience with.  Don't see the specific skills you are hiring for?   No problem - I can learn a new stack front to back well enough to get site up in only three weeks.</p>
				<div className="bars">
				   <ul className="skills">
					   {skills}
					</ul>
